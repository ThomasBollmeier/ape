...
class BaseParser extends parsian\Parser
{
    ...
    private function prod()
    {
        ...
        return $grammar->seq()
            ->add($grammar->ruleRef("disjunction"))
